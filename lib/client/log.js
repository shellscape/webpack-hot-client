...
const methodFactory = new MethodFactory(log);
methodFactory.make = (methodName) => {
  const og = MethodFactory.prototype.make.call(methodFactory, methodName);
